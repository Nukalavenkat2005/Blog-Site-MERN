      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non eos in necessitatibus quis? Dolorum, ab!
          </h1>
          ...
          <p className="text-gray-500 font-medium">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, neque distinctio sed iure minima molestias nulla deleniti veniam sequi quibusdam?
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-between">
        ...
        <div className="px-4 h-max sticky top-8" >
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-gray">Lorem ipsum dolor sit amet consectetur</p>
